...
\begin{longtable}[c]{|c|c|c|c|}
 \hline
 \rowcolor{gray!50}
Nombre del token               & Descripción informal                                                                                                                    & Expresión LEX                  & Lexemas \\ \hline
\endhead
...
\multicolumn{1}{|c|}{TUNTIL}   & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Es una palabra reservada que se compone por los caracteres\\ u n t i l\end{tabular}}     & \multicolumn{1}{c|}{"unHl"}    & unHl    \\ \hline
